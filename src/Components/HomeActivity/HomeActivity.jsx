            ...
            <div className={`${style.contentActivity} modal-content`}>
              ...
              <div className="modal-body">
                <p>
                  ...
                  totam eos illum officiis. Sequi illum dignissimos corrupti,
                  neque libero quod ipsam, a consequuntur, error blanditiis
                  totam similique facere repellat soluta?
                </p>
              </div>
            </div>
          </div>
